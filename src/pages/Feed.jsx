                ...
                <div className="mt-1 flex items-center justify-between gap-2">
                  <span className="text-[11px] text-slate-500">
                    ...
                    {(spot.createdBy != null && String(spot.createdBy).trim())
                      ...
                      : (spot.createdByDisplayName != null && String(spot.createdByDisplayName).trim())
                        ? (
                            <span className="ml-1 text-slate-600">· Added by {String(spot.createdByDisplayName).trim()}</span>
                          )
                        : (
