...
function Conversation({ currentUser, username, initialShare, onRead, showToast }) {
  ...
  const block = async () => {
    if (!profile || !window.confirm(`Block ${profile.display_name || 'SnapMap user'}? This also removes the friendship.`)) return;
