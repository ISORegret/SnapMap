...
export default function PhotoChallengeMapShortcut() {
  ...
  return <Link to={`/challenge/${challenge.id}`} className="surface-card absolute bottom-[7.15rem] right-3 z-[1003] flex max-w-[15.5rem] items-center gap-2.5 rounded-full border-accent-500/25 bg-[var(--bg-nav)] py-2 pl-2 pr-1.5 shadow-2xl backdrop-blur-xl">
